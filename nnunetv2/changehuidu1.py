...
import glob
img_name ='/mnt/data/DATA/nnUNet_raw/Dataset121_fra/imagesTr/dataset6_CLINIC_0080_0000.nii.gz'
...
modified_data[mask_indexes2] = 1 #2254
# input_value3 = int(input("请输入一个需要更改的灰度值："))
modified_data[mask_indexes3] = 1 #  1858
# input_value4 = int(input("请输入一个需要更改的灰度值："))
modified_data[mask_indexes4] = 1 #2561
#
...
sitk.WriteImage(modified_data,  '/mnt/data/DATA/nnUNet_raw/metaltest/0321/preSeg.nii.gz'
)
# count += 1
print("修改成功")
...
# 用你的NIfTI文件路径替换下面的路径
nii_file_path =  '/mnt/data/DATA/nnUNet_raw/metaltest/0321/preSeg.nii.gz'
