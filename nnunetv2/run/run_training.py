...
def  run_training_entry():
    print('Running training entry')
    import argparse
    os.environ['CUDA_VISIBLE_DEVICES'] = "0"
    # print(f"Available CUDA devices: {torch.cuda.device_count()}")
    parser = argparse.ArgumentParser()
    parser.add_argument('-network_trainer', default='nnUNetv2_trainer')
    parser.add_argument('-dataset_name_or_id', type=str, default='149',
                        help='0, 1,3,4,, 5 or \'all\'')
    ...
    #                     help="Configuration that should be trained")
    # parser.add_argument('fold', type=str,ould be an int between 0 and 4.')

    parser.add_argument('-tr', type=str, default='AGSSArconvLstmASFEBTrainer_Clean',
    ...
    parser.add_argument('--c', action='store_true', required=False,default='--c',
