from nnunetv2.net.YuNet.ArconvNet import UXlstmBotArconv
from nnunetv2.net.YuNet.UxlstmBot import UXlstmBot
# from nnunetv2.temp.caunet import CAPlainConvUNet
...
class ArconvTrainer(nnUNetTrainer):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        segmentation_network_class_name = 'LstmBotArconv'
        mapping = {
            'PlainConvUNet': PlainConvUNet,
            'ResidualEncoderUNet': ResidualEncoderUNet,
            'LstmBotArconv': UXlstmBotArconv
        }
        kwargs = {
            'PlainConvUNet': {
                'conv_bias': True,
