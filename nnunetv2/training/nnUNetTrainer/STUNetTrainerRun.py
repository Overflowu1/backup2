...
class STUNetTrainerRun(nnUNetTrainer):
...
class STUNetTrainer_small(STUNetTrainerRun):
    @staticmethod
    def build_network_architecture(plans_manager,
                                   dataset_json,
                                   configuration_manager,
...
class STUNetTrainer_base(STUNetTrainerRun):
    @staticmethod
    def build_network_architecture(plans_manager,
                                   dataset_json,
                                   configuration_manager,
...
class STUNetTrainer_large(STUNetTrainerRun):
    @staticmethod
    def build_network_architecture(plans_manager,
                                   dataset_json,
                                   configuration_manager,
...
class STUNetTrainer_huge(STUNetTrainerRun):
    @staticmethod
    def build_network_architecture(plans_manager,
                                   dataset_json,
                                   configuration_manager,
