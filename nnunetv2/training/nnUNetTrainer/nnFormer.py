...
class WindowAttention_kv(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.relative_position_bias_table = nn.Parameter(
            torch.zeros((2 * window_size - 1) * (2 * window_size - 1) * (2 * window_size - 1),
                        num_heads))
...
class BasicLayer(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.window_size = window_size
        self.shift_size = [window_size // 2, window_size // 2, window_size // 2]
        self.depth = depth
...
class nnFormer2(nn.Module):
    def __init__(self, crop_size=[64, 128, 128],
        ...
        self.encoder = Encoder(pretrain_img_size=crop_size, window_size=window_size, embed_dim=embed_dim,
