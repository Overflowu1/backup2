...
from nnunetv2.net.YuNet.ASFEBNet import ASFEBPlainConvUNet
...
class ASFEBTrainer(nnUNetTrainer):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        segmentation_network_class_name = 'ASFEBNet'
        mapping = {
            'PlainConvUNet': PlainConvUNet,
            'ResidualEncoderUNet': ResidualEncoderUNet,
            'ASFEBNet': ASFEBPlainConvUNet
        }
        kwargs = {
            'PlainConvUNet': {
                'conv_bias': True,
