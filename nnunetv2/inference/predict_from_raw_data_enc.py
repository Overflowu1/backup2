...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset031_301shuzhong/nnUNetTrainer__nnUNetResEncUNetLPlans__3d_lowres'),
        use_folds=(2,),
        checkpoint_name='checkpoint_final.pth',
    )
    predictor.predict_from_files(join('/mnt/data/DATA/0911'),
                                 join('/mnt/data/DATA/0911/31'),
