...
def predict_entry_point_modelfolder():
    ...
    parser.add_argument('-i', type=str, required=True,
                        default='/home/yu/nnUNet/nnUNetFrame/DATASET/nnUNet_raw/Dataset105_fracture/imagesTs',
                        help='input folder. Remember to use the correct channel numberings for your files (_0000 etc). '
                             'File endings must be the same as the training dataset!')
    parser.add_argument('-o', type=str, required=True, default='/home/yu/test/105',
...
def seg(imageInput):
    ...
    imageOutput = "/home/ps/wyc"

    nnUNet_raw = "/mnt/data/DATA/nnUNet_raw"
    nnUNet_preprocessed = "/mnt/data/DATA/nnUNet_preprocessed"
    nnUNet_results = "/mnt/data/DATA/nnUNet_results"
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset112_fra/nnUNetTrainer__nnUNetPlans__3d_lowres'),
        use_folds=(0,),
        checkpoint_name='checkpoint_final.pth',
    )
    predictor.predict_from_files(imageInput,
                                 imageOutput,
...
#
# img, props = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset105_fracture/imagesTs/CLINIC_0099_data_0000.nii.gz')])
