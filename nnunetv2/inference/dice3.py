...
def align_images_to_reference(image, reference):
    resample = sitk.ResampleImageFilter()
    resample.SetReferenceImage(reference)
    resample.SetInterpolator(sitk.sitkNearestNeighbor)
    aligned_image = resample.Execute(image)
...
def process_data_folder(prediction_folder, ground_truth_folder):
    ...
    for prediction_file in prediction_files:
        ...
        unique_labels = np.unique(sitk.GetArrayFromImage(ground_truth))
        print(unique_labels)
        aligned_prediction = align_images_to_reference(prediction, ground_truth)
        hd95_values_per_label = compute_hausdorff_95(aligned_prediction, ground_truth, labels=unique_labels)
        # Calculate HD95 for each label separately
        # hd95_values_per_label = compute_hausdorff_95(prediction, ground_truth, labels=unique_labels)
...
# prediction_folder = r'/mnt/data/DATA/zjyData/predict/123/5metric/predict'
# ground_truth_folder = r'/mnt/data/DATA/zjyData/predict/123/5metric/GT'
# prediction_folder = r'/mnt/data/DATA/zjyData/predict/123/STUNet/metric'
# ground_truth_folder = r'/mnt/data/DATA/zjyData/predict/labelTsOld'
# prediction_folder = r'/mnt/data/DATA/zjyData/predict/123/newData/NoArconv/metric'
# ground_truth_folder = r'/mnt/data/DATA/zjyData/VISUAL/new/guzheLabel'


# prediction_folder = r'/mnt/data/DATA/zjyCopy/imagesTs_predlowres/ULstmBotTrainer__nnUNetPlans__3d_lowres'
# ground_truth_folder = r'/mnt/data/DATA/nnUNet_raw/Dataset112_fra/labelsTs'

# prediction_folder = r'/home/yu/nnUNet/nnUNetFrame/DATASET/nnUNet_raw/Dataset112_fra/test/pred'
# ground_truth_folder = r'/home/yu/nnUNet/nnUNetFrame/DATASET/nnUNet_raw/Dataset112_fra/test/label'
