...
# from nnunetv2.training.nnUNetTrainer.variants.network_architecture.NexToU_Encoder_Decoder import NexToU_Encoder, \
#     NexToU_Decoder
from nnunetv2.net.MiFDeU.network_architecture.NexToU_Encoder_Decoder import NexToU_Encoder, \
    NexToU_Decoder
...
class NexToU(nn.Module):
    def __init__(self,
        ...
        self.decoder = NexToU_Decoder(self.encoder, patch_size, strides, num_classes, n_blocks_per_stage_decoder,
                                      deep_supervision)
