...
class ASFEBPlainConvUNet(nn.Module):
    def __init__(self,
                 input_channels: int,
                 n_stages: int,
...
class Decoder(nn.Module):
    def __init__(self,
        ...
        for s in range(1, n_stages_encoder):
            ...
            # 添加 ASFEB 层
            asfeb_modules.append(ASFEB(input_features_skip,input_features_skip))  # 将 ASFEB 添加到列表中
        ...
        self.asfeb_modules = nn.ModuleList(asfeb_modules)  # 将 ASFEB 模块列表转换为 ModuleList
