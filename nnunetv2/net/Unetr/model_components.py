...
from nnunetv2.training.nnUNetTrainer.Unetr.layers import LayerNorm
from nnunetv2.training.nnUNetTrainer.Unetr.transformerblock import TransformerBlock
# from dynamic_network_architectures. import get_conv_layer, UnetResBlock


einops, _ = optional_import("einops")

class UnetrPPEncoder(nn.Module):
    def __init__(self, input_size=[153600, 19200, 24 * 10 * 10, 6*2 * 5 * 5],dims=[32, 64, 128, 256],
