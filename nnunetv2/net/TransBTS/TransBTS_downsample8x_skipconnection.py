...
from nnunetv2.training.nnUNetTrainer.TransBTS.Transformer import TransformerModel
from nnunetv2.training.nnUNetTrainer.TransBTS.PositionalEncoding import FixedPositionalEncoding,LearnedPositionalEncoding
from nnunetv2.training.nnUNetTrainer.TransBTS.Unet_skipconnection import Unet
...
#def TransBTS(dataset='acdc', _conv_repr=True, _pe_type="learned"):
# lits2017
